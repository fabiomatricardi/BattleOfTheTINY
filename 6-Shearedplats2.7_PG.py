...
convHistory = ''
modelfile = "models/q5_k_m-shearedplats-2.7b-v1.gguf"
repetitionpenalty = 1.15
contextlength=32000
logfile = 'shearedplats-2.7b_logs.txt'
print("loading model...")
...
with gr.Blocks(theme='Medguy/base2') as demo:   #theme=gr.themes.Glass()  #theme='remilia/Ghostly'
    ...
    with gr.Row(variant='compact'):
            with gr.Column(scale=3):            
                gr.Image(value='https://xiamengzhou.github.io/sheared-llama/Sheared%20LLaMA%20Accelerating%20Language%20Model%20Pre-trai%20b0f92218e6724c1fa44d8b5369550c15/sheared_llama.png', 
                        show_label = False, height = 150,
                        show_download_button = False, container = False,)              
            with gr.Column(scale=10):
                gr.HTML("<center>"
                + "<h3>Prompt Engineering Playground!</h3>"
                + "<h1>🦙 Shearedplats-2.7b-v - 32K context window</h2></center>")  
                with gr.Row():
    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            - **Model**: 🦙 q5_k_m-shearedplats-2.7b-v1.gguf
            - **Log File**: {logfile}
            """) 
