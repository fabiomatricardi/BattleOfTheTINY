...
logfile = 'OpenLlamaWizaardInstruct3.b_logs.txt'
print("loading model...")
...
with gr.Blocks(theme='Medguy/base2') as demo:   #theme=gr.themes.Glass()  #theme='remilia/Ghostly'
    ...
    with gr.Row(variant='compact'):
            ...
            with gr.Column(scale=10):
                ...
                + "<h1>🦙🧙‍♂️ open-llama-3b-v2-wizard-evol-instuct-v2 - 196K context window</h1></center>")  
                with gr.Row():
    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            max_len = gr.Slider(label="Maximum output lenght", minimum=10,maximum=(contextlength-250),step=2, value=900)
            gr.Markdown(
            """
            ...
            - **Model**: 🦙🧙‍♂️ OpenLlamaWizardInstruct-3B
            - **Log File**: {logfile}
            """) 
